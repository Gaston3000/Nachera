...
export function ProcessTimeline() {
  ...
  return (
    <section id="proceso" className="mx-auto w-full max-w-6xl px-5 py-20 sm:px-8 md:py-28">
      ...
      {/* Desktop: horizontal rail con 5 nodos peer (todos accent) */}
      <div className="hidden md:block">
          ...
          <div className="relative flex justify-between">
            {process.map((p, i) => (
              <motion.div
                ...
                transition={
                  reduce ? {} : { duration: 0.7, delay: i * 0.08, ease: EASE }
                }
              >
                <div className="relative z-10 flex h-10 w-10 items-center justify-center rounded-full border-2 border-accent bg-bg shadow-[0_0_20px_-4px_var(--c-accent)]">
        ...
        {/* step content — 5 columnas alineadas 1:1 con los dots del rail */}
        <div className="grid grid-cols-5 gap-5 lg:gap-6">
          {process.map((p, i) => (
            ...
            >
              <span className="font-display text-5xl font-black leading-none text-fg/5 select-none lg:text-6xl">
                {p.n}
              </span>
          ...
          <Reveal key={p.n} delay={i * 0.08}>
            <div className="relative flex gap-5 pb-8 last:pb-0">
              ...
              <div className="pt-1 pb-2">
                <span className="font-display text-4xl font-black text-fg/5 leading-none select-none block">
                  {p.n}
                </span>
